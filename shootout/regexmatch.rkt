...
(time (begin (main (vector #f (lambda () (mk-regexmatch-input 10)))) (void)))
; (time (begin (main (vector #f (lambda () (mk-regexmatch-input 1000000)))) (void)))
