...
(define/contract
  ...
  (-> array? (vectorof natural-number/c) array?)
...
(define/contract
  ...
  (-> (vectorof natural-number/c) (vectorof natural-number/c) (-> none/c) (or/c 'permissive #t) (vectorof natural-number/c))
...
(define/contract
  ...
  (->* ((listof (vectorof natural-number/c))) (none/c) (vectorof natural-number/c))
