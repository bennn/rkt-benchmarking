...
(begin-encourage-inline
  ...
  (define/contract
    ...
    (-> (vectorof natural-number/c) (vectorof natural-number/c))
  ...
  (define/contract
    (array-shape-size ds)
    (-> (vectorof natural-number/c) natural-number/c)
  ...
  (define/contract
    ...
    (-> symbol? (vectorof natural-number/c) natural-number/c)
  ...
  (define/contract
    ...
    (-> (vectorof natural-number/c) (-> none/c) (vectorof natural-number/c))
    (define dims (vector-length ds))
  ...
  (define/contract
    ...
    (-> (vectorof natural-number/c) (vectorof natural-number/c) natural-number/c)
    (define dims (vector-length ds))
    (let loop ([i 0] [j 0])
      (cond [(i . < . dims)
             (define di (unsafe-vector-ref ds i))
...
(define/contract
  ...
  (-> symbol? (vectorof natural-number/c) any/c none/c)
...
(define/contract
  ...
  (-> (vectorof natural-number/c) natural-number/c (vectorof natural-number/c))
...
(define/contract
  ...
  (-> (vectorof natural-number/c) natural-number/c any/c (vectorof natural-number/c))
  (define n (vector-length vec))
...
(define/contract
  ...
  (-> (vectorof natural-number/c) natural-number/c (vectorof natural-number/c) void?)
  (let loop ([k  dims])
    (unless (zero? k)
      (let ([k  (- k 1)])
