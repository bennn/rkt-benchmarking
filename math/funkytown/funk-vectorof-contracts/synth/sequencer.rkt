...
(define/contract
  ...
  (-> (or/c #f natural-number/c) natural-number/c (-> flonum? (-> (vectorof natural-number/c) (real-in -1 1))) array?)
...
(define/contract
  ...
  (-> natural-number/c pattern? natural-number/c (-> flonum? (-> (vectorof natural-number/c) (real-in -1 1))) array?)
