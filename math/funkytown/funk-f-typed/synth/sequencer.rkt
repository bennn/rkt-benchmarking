...
(define-type Pattern (Listof (Pairof (U #f Natural) Natural)))

(: base+relative-semitone->freq (-> Natural Natural Natural))
...
(: scale (->* (Natural Natural Natural Symbol) #:rest Natural None))
...
(: chord (->* (Natural Natural Natural Natural) #:rest Natural None))
...
(: sequence (-> Natural Pattern Natural (-> Float (-> Vector Float)) Array))
